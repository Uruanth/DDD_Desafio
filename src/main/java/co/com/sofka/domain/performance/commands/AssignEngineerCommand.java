...
public class AssignEngineerCommand extends Command {
    ...
    public AssignEngineerCommand(PerformanceId performanceId, EngineerId engineerId, PersonalInformation personalInformation, CommissionedArea commissionedArea, RequestPerformance order) {
